...
- **Function parity:** 88/374 matched (target 156) — 23.5%
- **Class/type parity:** 48/89 matched (target 107) — 53.9%
- **Combined symbol parity:** 136/463 matched (target 263) — 29.4%
- **Average inline-code cosine:** 0.15 (function body across 19 matched files)
