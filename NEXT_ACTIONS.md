...
- **Function parity:** 88/420 matched (target 154) — 21.0%
- **Class/type parity:** 48/97 matched (target 106) — 49.5%
- **Combined symbol parity:** 136/517 matched (target 260) — 26.3%
...
- **Tests:** 0/22 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `parsing/syntax_set.rs` vs expected `parsing/syntax_set.rs`
- **Proposed provenance header:** `// port-lint: source parsing/syntax_set.rs` (current: `// port-lint: source parsing/syntax_set.rs`)
- **Lint issues:** 1
...
- **Tests:** 0/1 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `highlighting/theme_set.rs` vs expected `highlighting/theme_set.rs`
- **Proposed provenance header:** `// port-lint: source highlighting/theme_set.rs` (current: `// port-lint: source highlighting/theme_set.rs`)
- **Lint issues:** 1
...
- **Missing types:** _none_
- **Tests:** 0/2 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `parsing/regex.rs` vs expected `parsing/regex.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:parsing/regex.rs` vs expected `parsing/regex.rs`
- **Proposed provenance header:** `// port-lint: source parsing/regex.rs` (current: `// port-lint: source parsing/regex.rs`)
- **Proposed provenance header:** `// port-lint: tests parsing/regex.rs` (current: `// port-lint: tests parsing/regex.rs`)
- **Lint issues:** 2
...
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `escape.rs` vs expected `escape.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:escape.rs` vs expected `escape.rs`
- **Proposed provenance header:** `// port-lint: source escape.rs` (current: `// port-lint: source escape.rs`)
- **Proposed provenance header:** `// port-lint: tests escape.rs` (current: `// port-lint: tests escape.rs`)
- **Lint issues:** 2

### 5. highlighting.theme

- **Target:** `highlighting.Theme [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 2
...
- **Types:** 4/4 matched
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `highlighting/theme.rs` vs expected `highlighting/theme.rs`
- **Proposed provenance header:** `// port-lint: source highlighting/theme.rs` (current: `// port-lint: source highlighting/theme.rs`)
- **Lint issues:** 1

### 6. parsing.syntax_definition

- **Target:** `parsing.SyntaxDefinition [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 1
...
- **Tests:** 0/1 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `parsing/syntax_definition.rs` vs expected `parsing/syntax_definition.rs`
- **Proposed provenance header:** `// port-lint: source parsing/syntax_definition.rs` (current: `// port-lint: source parsing/syntax_definition.rs`)
- **Lint issues:** 1
...
- **Tests:** 0/5 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `parsing/scope.rs` vs expected `parsing/scope.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:parsing/scope.rs` vs expected `parsing/scope.rs`
- **Proposed provenance header:** `// port-lint: source parsing/scope.rs` (current: `// port-lint: source parsing/scope.rs`)
- **Proposed provenance header:** `// port-lint: tests parsing/scope.rs` (current: `// port-lint: tests parsing/scope.rs`)
- **Lint issues:** 2
...
- **Tests:** 0/48 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `parsing/parser.rs` vs expected `parsing/parser.rs`
- **Proposed provenance header:** `// port-lint: source parsing/parser.rs` (current: `// port-lint: source parsing/parser.rs`)
- **Lint issues:** 2

### 9. parsing.yaml_load

- **Target:** `parsing.YamlLoad [ZERO] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
...
- **Tests:** 0/13 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `parsing/yaml_load.rs` vs expected `parsing/yaml_load.rs`
- **Proposed provenance header:** `// port-lint: source parsing/yaml_load.rs` (current: `// port-lint: source parsing/yaml_load.rs`)
- **Lint issues:** 1
...
- **Tests:** 0/6 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `parsing/metadata.rs` vs expected `parsing/metadata.rs`
- **Proposed provenance header:** `// port-lint: source parsing/metadata.rs` (current: `// port-lint: source parsing/metadata.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `highlighting/style.rs` vs expected `highlighting/style.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:highlighting/style.rs` vs expected `highlighting/style.rs`
- **Proposed provenance header:** `// port-lint: source highlighting/style.rs` (current: `// port-lint: source highlighting/style.rs`)
- **Proposed provenance header:** `// port-lint: tests highlighting/style.rs` (current: `// port-lint: tests highlighting/style.rs`)
- **Lint issues:** 2
...
- **Missing types:** _none_
- **Tests:** 0/3 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `dumps.rs` vs expected `dumps.rs`
- **Proposed provenance header:** `// port-lint: source dumps.rs` (current: `// port-lint: source dumps.rs`)
- **Lint issues:** 1
...
- **Missing types:** _none_
- **Tests:** 1/9 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `html.rs` vs expected `html.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:html.rs` vs expected `html.rs`
- **Proposed provenance header:** `// port-lint: source html.rs` (current: `// port-lint: source html.rs`)
- **Proposed provenance header:** `// port-lint: tests html.rs` (current: `// port-lint: tests html.rs`)
- **Lint issues:** 2
...
- **Tests:** 0/5 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `easy.rs` vs expected `easy.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:easy.rs` vs expected `easy.rs`
- **Proposed provenance header:** `// port-lint: source easy.rs` (current: `// port-lint: source easy.rs`)
- **Proposed provenance header:** `// port-lint: tests easy.rs` (current: `// port-lint: tests easy.rs`)
- **Lint issues:** 2
...
- **Missing types:** `Item`
- **Tests:** 0/4 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `highlighting/highlighter.rs` vs expected `highlighting/highlighter.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:highlighting/highlighter.rs` vs expected `highlighting/highlighter.rs`
- **Proposed provenance header:** `// port-lint: source highlighting/highlighter.rs` (current: `// port-lint: source highlighting/highlighter.rs`)
- **Proposed provenance header:** `// port-lint: tests highlighting/highlighter.rs` (current: `// port-lint: tests highlighting/highlighter.rs`)
- **Lint issues:** 2
...
- **Missing types:** `Err`
- **Tests:** 0/4 matched
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `highlighting/selector.rs` vs expected `highlighting/selector.rs`
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:highlighting/selector.rs` vs expected `highlighting/selector.rs`
- **Proposed provenance header:** `// port-lint: source highlighting/selector.rs` (current: `// port-lint: source highlighting/selector.rs`)
- **Proposed provenance header:** `// port-lint: tests highlighting/selector.rs` (current: `// port-lint: tests highlighting/selector.rs`)
- **Lint issues:** 2
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `highlighting/theme_load.rs` vs expected `highlighting/theme_load.rs`
- **Proposed provenance header:** `// port-lint: source highlighting/theme_load.rs` (current: `// port-lint: source highlighting/theme_load.rs`)
- **Lint issues:** 1
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `highlighting/settings.rs` vs expected `highlighting/settings.rs`
- **Proposed provenance header:** `// port-lint: source highlighting/settings.rs` (current: `// port-lint: source highlighting/settings.rs`)
- **Lint issues:** 1
...
- **Types:** 0/0 matched (target 1)
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `utils.rs` vs expected `utils.rs`
- **Proposed provenance header:** `// port-lint: source utils.rs` (current: `// port-lint: source utils.rs`)
- **Lint issues:** 1

### 21. lib

- **Target:** `syntect.Mod [PROVENANCE-FALLBACK]`
- **Similarity:** 1.00
- **Dependents:** 0
...
- **Target:** `parsing.Mod [STUB] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
- **Priority Score:** 10.0
- **Functions:** 0/0 matched
...
- **Types:** 0/0 matched (target 1)
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `parsing/mod.rs` vs expected `parsing/mod.rs`
- **Proposed provenance header:** `// port-lint: source parsing/mod.rs` (current: `// port-lint: source parsing/mod.rs`)
- **Lint issues:** 1

### 23. highlighting.mod

- **Target:** `highlighting.Mod [STUB] [PROVENANCE-FALLBACK]`
- **Similarity:** 0.00
- **Dependents:** 0
- **Priority Score:** 10.0
- **Functions:** 0/0 matched
...
- **Types:** 0/0 matched (target 1)
- **Missing types:** _none_
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `highlighting/mod.rs` vs expected `highlighting/mod.rs`
- **Proposed provenance header:** `// port-lint: source highlighting/mod.rs` (current: `// port-lint: source highlighting/mod.rs`)
- **Lint issues:** 1
...
|--------|-----------------|------|-------------|---------------|
| `highlight_utils.mod` | `benches.highlightutils.Mod` | 0 | `benches/highlight_utils/mod.rs` | `benches/highlightutils/Mod.kt` |
| `utils.mod` | `benches.utils.Mod` | 0 | `benches/utils/mod.rs` | `benches/utils/Mod.kt` |
