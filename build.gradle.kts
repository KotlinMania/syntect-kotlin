...
kotlin {
    ...
    val xcf = XCFramework("Syntect")

    macosArm64 {
        binaries.framework { baseName = "Syntect"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Syntect"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Syntect"
        flattenPackage = "io.github.kotlinmania.syntect"
    }

    android {
        namespace = "io.github.kotlinmania.syntect"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "syntect-kotlin", version.toString())

    pom {
        name.set("syntect-kotlin")
        description.set("Kotlin Multiplatform port of trishume/syntec - library for high quality syntax highlighting and code intelligence using Sublime Text's grammars")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/syntect-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/syntect-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/syntect-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/syntect-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSyntectXCFramework",
    "assembleSyntectDebugXCFramework",
    "assembleSyntectReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSyntectXCFramework",
    "assembleReleaseIosFatFrameworkForSyntectXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSyntectXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSyntectXCFramework",
    "assembleDebugMacosFatFrameworkForSyntectXCFramework",
    "assembleReleaseMacosFatFrameworkForSyntectXCFramework",
    "assembleDebugTvosFatFrameworkForSyntectXCFramework",
    "assembleReleaseTvosFatFrameworkForSyntectXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSyntectXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSyntectXCFramework",
    "assembleDebugWatchosFatFrameworkForSyntectXCFramework",
    "assembleReleaseWatchosFatFrameworkForSyntectXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSyntectXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSyntectXCFramework",
