...
This file is the quick-reference operating contract for syntect-kotlin. The longer
...
syntect-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`syntect`](https://crates.io/crates/syntect). Upstream Rust is the behavioral oracle while the
